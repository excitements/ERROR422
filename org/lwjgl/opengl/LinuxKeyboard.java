...
/*  74 */   private final CharBuffer char_buffer = CharBuffer.allocate(50); private boolean has_deferred_event; private int deferred_keycode; private int deferred_event_keycode; private long deferred_nanos; private byte deferred_key_state;
...
/* 182 */     this.tmp_event.putInt(keycode).put(state).putInt(ch).putLong(nanos).put(repeat ? 1 : 0);
...
/* 245 */     return (keysym == 0L || (keysym & 0x10000000L) != 0L);
/*     */   }
/*     */   
...
/*     */     } else {
/* 266 */       group = 0;
/* 267 */     }  long keysym; if ((event_state & this.numlock_mask) != 0 && isKeypadKeysym(keysym = getKeySym(event_ptr, group, 1))) {
/* 268 */       if ((event_state & (0x1L | this.shift_lock_mask)) != 0L) {
/* 269 */         return getKeySym(event_ptr, group, 0);
/*     */       }
/* 271 */       return keysym;
/*     */     } 
/* 273 */     if ((event_state & 0x3L) == 0L)
/* 274 */       return getKeySym(event_ptr, group, 0); 
/* 275 */     if ((event_state & 0x1L) == 0L) {
/* 276 */       keysym = getKeySym(event_ptr, group, 0);
/* 277 */       if ((event_state & this.caps_lock_mask) != 0)
/* 278 */         keysym = toUpper(keysym); 
/* 279 */       return keysym;
/*     */     } 
/* 281 */     keysym = getKeySym(event_ptr, group, 1);
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjgl\opengl\LinuxKeyboard.class
