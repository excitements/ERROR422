...
/* 269 */     this.event.putInt(key_code).put(state).putInt(character).putLong(nanos).put(repeat ? 1 : 0);
/* 270 */     this.event.flip();
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjgl\opengl\KeyboardEventQueue.class
