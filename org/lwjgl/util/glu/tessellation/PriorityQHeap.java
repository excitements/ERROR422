...
/*  99 */   int size = 0;
/* 100 */   int max = 32;
/* 101 */   PriorityQ.PQnode[] nodes = new PriorityQ.PQnode[33]; PriorityQ.PQhandleElem[] handles; int freeList; public PriorityQHeap(PriorityQ.Leq leq) { int i;
/* 102 */     for (i = 0; i < this.nodes.length; i++) {
/* 103 */       this.nodes[i] = new PriorityQ.PQnode();
/*     */     }
/* 105 */     this.handles = new PriorityQ.PQhandleElem[33];
/* 106 */     for (i = 0; i < this.handles.length; i++) {
...
/*     */   
/*     */   boolean initialized; PriorityQ.Leq leq; static final boolean $assertionsDisabled;
/*     */   
...
/* 215 */       for (int j = this.handles.length; j < pqHandles.length; j++) {
/* 216 */         pqHandles[j] = new PriorityQ.PQhandleElem();
/*     */       }
...
/* 237 */       FloatUp(curr);
/*     */     }
/* 239 */     assert free != Integer.MAX_VALUE;
/* 240 */     return free;
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 258 */     if (this.size > 0 && --this.size > 0) {
/* 259 */       FloatDown(1);
/*     */     }
/*     */     
/* 262 */     return min;
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjg\\util\glu\tessellation\PriorityQHeap.class
