...
/* 552 */     GLUhalfEdge e, eStart = fZap.anEdge;
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 720 */     GLUface fPrev = fHead; GLUface f;
/* 721 */     for (fPrev = fHead; (f = fPrev.next) != fHead; ) {
/* 722 */       assert f.prev == fPrev;
/* 723 */       GLUhalfEdge gLUhalfEdge = f.anEdge;
/*     */       while (true)
/* 725 */       { assert gLUhalfEdge.Sym != gLUhalfEdge;
/* 726 */         assert gLUhalfEdge.Sym.Sym == gLUhalfEdge;
/* 727 */         assert gLUhalfEdge.Lnext.Onext.Sym == gLUhalfEdge;
/* 728 */         assert gLUhalfEdge.Onext.Sym.Lnext == gLUhalfEdge;
/* 729 */         assert gLUhalfEdge.Lface == f;
/* 730 */         gLUhalfEdge = gLUhalfEdge.Lnext;
/* 731 */         if (gLUhalfEdge == f.anEdge)
/*     */           fPrev = f;  } 
/* 733 */     }  assert f.prev == fPrev && f.anEdge == null && f.data == null;
/*     */     
/* 735 */     GLUvertex vPrev = vHead; GLUvertex v;
/* 736 */     for (vPrev = vHead; (v = vPrev.next) != vHead; ) {
/* 737 */       assert v.prev == vPrev;
/* 738 */       GLUhalfEdge gLUhalfEdge = v.anEdge;
/*     */       while (true)
/* 740 */       { assert gLUhalfEdge.Sym != gLUhalfEdge;
/* 741 */         assert gLUhalfEdge.Sym.Sym == gLUhalfEdge;
/* 742 */         assert gLUhalfEdge.Lnext.Onext.Sym == gLUhalfEdge;
/* 743 */         assert gLUhalfEdge.Onext.Sym.Lnext == gLUhalfEdge;
/* 744 */         assert gLUhalfEdge.Org == v;
/* 745 */         gLUhalfEdge = gLUhalfEdge.Onext;
/* 746 */         if (gLUhalfEdge == v.anEdge)
/*     */           vPrev = v;  } 
/* 748 */     }  assert v.prev == vPrev && v.anEdge == null && v.data == null;
/*     */     
/* 750 */     GLUhalfEdge ePrev = eHead; GLUhalfEdge e;
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjg\\util\glu\tessellation\Mesh.class
