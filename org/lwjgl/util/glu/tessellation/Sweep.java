...
/*  292 */     (RegionAbove(reg)).windingNumber += reg.eUp.winding;
...
/*      */     }
/*  401 */     ActiveRegion regPrev = regUp;
...
/*  495 */     isect.coords[0] = isect.coords[0] + weights[0] * org.coords[0] + weights[1] * dst.coords[0];
/*  496 */     isect.coords[1] = isect.coords[1] + weights[0] * org.coords[1] + weights[1] * dst.coords[1];
/*  497 */     isect.coords[2] = isect.coords[2] + weights[0] * org.coords[2] + weights[1] * dst.coords[2];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  519 */     isect.coords[2] = 0.0D; isect.coords[1] = 0.0D; isect.coords[0] = 0.0D;
...
/* 1004 */     GLUhalfEdge eLast = eTopRight.Onext, eTopLeft = eLast;
...
/* 1065 */       GLUhalfEdge eNew; if (reg == regUp) {
...
/*      */     
/* 1160 */     e.Org.s = 4.0E150D;
/* 1161 */     e.Org.t = t;
/* 1162 */     e.Sym.Org.s = -4.0E150D;
/* 1163 */     e.Sym.Org.t = t;
...
/* 1185 */             return Sweep.EdgeLeq(tess, (ActiveRegion)key1, (ActiveRegion)key2);
/*      */           } private final GLUtessellatorImpl val$tess;
/*      */         });
/* 1188 */     if (tess.dict == null) throw new RuntimeException();
/*      */     
/* 1190 */     AddSentinel(tess, -4.0E150D);
/* 1191 */     AddSentinel(tess, 4.0E150D);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */     
/* 1271 */     GLUvertex vHead = tess.mesh.vHead; GLUvertex v;
/* 1272 */     for (v = vHead.next; v != vHead; v = v.next) {
/* 1273 */       v.pqHandle = pq.pqInsert(v);
/* 1274 */       if (v.pqHandle == Long.MAX_VALUE)
/*      */         break; 
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjg\\util\glu\tessellation\Sweep.class
