...
/*     */   
/*  54 */   private static final ThreadLocal thread_buffer = new ThreadLocal() {
/*     */       protected Object initialValue() {
/*  56 */         return new NondirectBufferWrapper.CachedBuffers(1);
/*     */       }
/*     */     };
/*     */   
/*     */   private static CachedBuffers getCachedBuffers(int minimum_byte_size) {
/*  61 */     CachedBuffers buffers = thread_buffer.get();
/*  62 */     int current_byte_size = buffers.byte_buffer.capacity();
/*  63 */     if (minimum_byte_size > current_byte_size) {
/*  64 */       buffers = new CachedBuffers(minimum_byte_size);
...
/* 395 */       this.byte_buffer = ByteBuffer.allocateDirect(size);
...
/* Location:              C:\Users\fract\Downloads\ERROR422.jar!\org\lwjgl\NondirectBufferWrapper.class
