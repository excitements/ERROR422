...
/*     */       
/* 102 */       PluginLoader loader = new PluginLoader(f);
/* 103 */       JarFile jf = new JarFile(f);
/* 104 */       for (Enumeration en = jf.entries(); en.hasMoreElements(); ) {
/* 105 */         JarEntry je = en.nextElement();
/*     */         
...
/* 137 */     return (Class[])this.pluginList.toArray((Object[])pluginArray);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     for (int j = 0; j < interfaces.length; j++) {
/* 152 */       interfaceSet.add(interfaces[j]);
/*     */     }
/* 154 */     for (Iterator i = this.pluginList.iterator(); i.hasNext(); ) {
/* 155 */       Class pluginClass = i.next();
...
/* 161 */     return (Class[])matchList.<Class[]>toArray((Class[][])pluginArray);
/*     */   }
/*     */   
/*     */   private boolean classImplementsAny(Class testClass, Set interfaces) {
/* 165 */     if (testClass == null) return false; 
/* 166 */     Class[] implementedInterfaces = testClass.getInterfaces(); int i;
/* 167 */     for (i = 0; i < implementedInterfaces.length; i++) {
/* 168 */       if (interfaces.contains(implementedInterfaces[i])) {
/* 169 */         return true;
/*     */       }
/*     */     } 
/* 172 */     for (i = 0; i < implementedInterfaces.length; i++) {
...
/* 191 */     for (int j = 0; j < interfaces.length; j++) {
/* 192 */       interfaceSet.add(interfaces[j]);
/*     */     }
/* 194 */     for (Iterator i = this.pluginList.iterator(); i.hasNext(); ) {
/* 195 */       Class pluginClass = i.next();
...
/* 201 */     return (Class[])matchList.<Class[]>toArray((Class[][])pluginArray);
/*     */   }
/*     */   
/*     */   private boolean classImplementsAll(Class testClass, Set interfaces) {
/* 205 */     if (testClass == null) return false; 
/* 206 */     Class[] implementedInterfaces = testClass.getInterfaces(); int i;
/* 207 */     for (i = 0; i < implementedInterfaces.length; i++) {
...
/*     */       } 
/*     */     } 
/* 215 */     for (i = 0; i < implementedInterfaces.length; i++) {
