...
/* 114 */   private final boolean[] key_states = new boolean[255];
/*     */   
...
/* 209 */       dx = event.getLastX() - this.last_x;
/* 210 */       dy = event.getLastY() - this.last_y;
