...
/*  85 */     return AccessController.<String>doPrivileged(new PrivilegedAction() {
/*     */           public Object run() {
/*  87 */             return System.getProperty(property);
/*     */           }
...
/*  94 */     return AccessController.<String>doPrivileged(new PrivilegedAction() {
/*     */           public Object run() {
/*  96 */             return System.getProperty(property, default_value);
/*     */           }
/*     */ 
/*     */           
/*     */           private final String val$property;
...
/* 160 */               this.loadedPlugins.add(ce.getClass().getName()); continue;
/*     */             } 
...
/*     */ 
/*     */           
/* 206 */           ControllerEnvironment ce = envClasses[i].newInstance();
/*     */           
