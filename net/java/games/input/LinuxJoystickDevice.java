...
/*  80 */     this.event_queue = new EventQueue(size);
/*     */   }
/*     */   
...
/* 107 */               pov.updateValue();
/* 108 */               this.event.set(pov, pov.getPollData(), joystick_event.getNanos()); break;
/* 109 */             }  if (this.povYs.containsKey(new Integer(index))) {
/* 110 */               LinuxJoystickPOV pov = (LinuxJoystickPOV)this.povYs.get(new Integer(index));
/* 111 */               pov.updateValue();
/* 112 */               this.event.set(pov, pov.getPollData(), joystick_event.getNanos()); break;
/*     */             } 
...
/*     */     
/*     */     int xIndex;
/* 143 */     for (xIndex = 0; xIndex < this.axes.length && 
/* 144 */       this.axes[xIndex] != xAxis; xIndex++);
/*     */     
/*     */     int yIndex;
/*     */     
/* 148 */     for (yIndex = 0; yIndex < this.axes.length && 
