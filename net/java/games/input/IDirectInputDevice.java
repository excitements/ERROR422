...
/* 245 */       DIDeviceObject obj = this.objects.get(i);
/* 246 */       if (obj.isAxis()) {
/* 247 */         has_axis = true;
...
/* 275 */     return (Rumbler[])this.rumblers.toArray((Object[])new Rumbler[0]);
/*     */   }
/*     */   
...
/* 286 */       DIEffectInfo info = this.effects.get(i);
...
/* 307 */       DIDeviceObject object = this.objects.get(i);
...
/* 324 */     return this.objects.get(format_offset);
/*     */   }
/*     */   
...
/* 365 */     int res = nAcquire(this.address);
...
/* 379 */     int res = nGetDeviceData(this.address, 0, queue, queue.getElements(), queue.position(), queue.remaining());
/* 380 */     if (res != 0 && res != 1) {
...
/* 408 */     this.objects.toArray((Object[])device_objects);
...
/* 530 */         IDirectInputEffect effect = this.rumblers.get(i);
/* 531 */         effect.release();
/*     */       } 
