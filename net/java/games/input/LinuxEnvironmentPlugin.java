...
/*  58 */     AccessController.doPrivileged(new PrivilegedAction() { private final String val$lib_name;
/*     */           
/*     */           public final Object run() {
/*  61 */             String lib_path = System.getProperty("net.java.games.input.librarypath");
/*     */             try {
/*  63 */               if (lib_path != null)
/*  64 */               { System.load(lib_path + File.separator + System.mapLibraryName(lib_name)); }
/*     */               else
/*  66 */               { System.loadLibrary(lib_name); } 
/*  67 */             } catch (UnsatisfiedLinkError e) {
/*  68 */               ControllerEnvironment.logln("Failed to load library: " + e.getMessage());
/*  69 */               e.printStackTrace();
/*  70 */               LinuxEnvironmentPlugin.supported = false;
/*     */             } 
/*  72 */             return null;
/*     */           } }
/*     */       );
...
/*  78 */     return AccessController.<String>doPrivileged(new PrivilegedAction() { private final String val$property;
/*     */           public Object run() {
/*  80 */             return System.getProperty(property);
/*     */           } }
/*     */       );
/*     */   }
/*     */ 
...
/*  87 */     return AccessController.<String>doPrivileged(new PrivilegedAction() { private final String val$property; private final String val$default_value;
/*     */           public Object run() {
/*  89 */             return System.getProperty(property, default_value);
/*     */           } }
/*     */       );
/*     */   }
/*     */   
...
/* 114 */       AccessController.doPrivileged(new PrivilegedAction() { private final LinuxEnvironmentPlugin this$0;
/*     */             
/*     */             public final Object run() {
/* 117 */               Runtime.getRuntime().addShutdownHook(new LinuxEnvironmentPlugin.ShutdownHook());
/* 118 */               return null;
/*     */             } }
/*     */         );
/*     */     } else {
...
/* 137 */     List components = new ArrayList(); int i;
/* 138 */     for (i = 0; i < event_components.size(); i++) {
/* 139 */       LinuxEventComponent event_component = event_components.get(i);
...
/* 236 */         Controller evController = eventControllers.get(i);
/* 237 */         Controller jsController = jsControllers.get(j);
/*     */ 
/*     */ 
/*     */         
...
/*     */     
/* 268 */     Controller[] controllers_array = new Controller[controllers.size()];
...
/*     */     int i;
/* 350 */     for (i = 0; i < device.getNumButtons(); i++) {
...
/*     */       } 
/*     */     } 
/* 358 */     for (i = 0; i < device.getNumAxes(); i++) {
/*     */       
...
/*     */     } 
/*     */     
/* 391 */     return new LinuxJoystickAbstractController(device, components.<Component>toArray(new Component[0]), new Controller[0], new Rumbler[0]);
/*     */   }
/*     */   
...
/* 413 */         logln("Failed to open device (" + event_file + "): " + e.getMessage());
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 428 */     return AccessController.<String>doPrivileged(new PrivilegedAction() { private final File val$file;
/*     */           public Object run() {
/* 430 */             return file.getAbsolutePath();
/*     */           } }
/*     */       );
/*     */   }
/*     */   
/*     */   private static File[] listFilesPrivileged(final File dir, final FilenameFilter filter) {
/* 436 */     return AccessController.<File[]>doPrivileged(new PrivilegedAction() { private final File val$dir; private final FilenameFilter val$filter;
/*     */           public Object run() {
/* 438 */             return dir.listFiles(filter);
/*     */           } }
/*     */       );
/*     */   }
/*     */   
...
/* 445 */     File[] event_device_files = listFilesPrivileged(dev, new FilenameFilter() { private final LinuxEnvironmentPlugin this$0;
/*     */           public final boolean accept(File dir, String name) {
...
/* 465 */           logln("Failed to create Controller: " + e.getMessage());
/* 466 */           device.close();
/*     */         } 
...
/*     */         try {
/* 478 */           LinuxDevice device = LinuxEnvironmentPlugin.this.devices.get(i);
/* 479 */           device.close();
